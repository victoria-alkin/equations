...
export default async function handler(req, res) {
  ...
  const text =
    ...
    `If you want a place to start, the daily puzzle is a good one: https://equationsgame.com/daily. There are three new equations of varying difficulty every morning, everyone plays the same set, so you can compare how you did with friends.\n\n` +
